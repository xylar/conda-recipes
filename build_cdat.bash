...
conda build -c conda-forge dv3d --python=27
conda build -c conda-forge dv3d --python=36
conda build -c conda-forge vcs --python=27
conda build -c conda-forge vcs --python=36
conda build -c conda-forge vcsaddons --python=27
conda build -c conda-forge vcsaddons --python=36
conda build -c conda-forge thermo --python=27
conda build -c conda-forge thermo --python=36
conda build -c conda-forge wk --python=27
conda build -c conda-forge wk --python=36
